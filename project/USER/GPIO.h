//*****************************************************************************
// Control_P0_1(mode, drivestrength); 
// Toggle(P0_1);
// Reset(P0_1);
// Set(P0_1);
//*****************************************************************************
...
// Definition of "mode"
#define INPUT           0x00//No input pull device connected
#define INPUT_PD        0x01//Input pull-down device connected
#define INPUT_PU        0x02//Input pull-up device connected
#define INPUT_PPS       0x03//No input pull device connected;Pn_OUTx continuously samples the input value
#define INPUT_INV       0x04//No input pull device connected
#define INPUT_INV_PD    0x05//Input pull-down device connected
#define INPUT_INV_PU    0x06//Input pull-up device connected
#define INPUT_INV_PPS   0x07//No input pull device connected;Pn_OUTx continuously samples the input value
...
// definition of "drivestrength"
#define WEAK            0x7
#define MEDIUM          0x4
#define STRONG          0x2
#define VERYSTRONG      0x1
